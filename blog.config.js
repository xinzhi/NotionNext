...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Zee', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || "I'm an energetic content creator who's passionate about hitting the road and sharing fascinating stuff on the web.", // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://til.xxz.cc', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Zee, TIL', // 网站关键词 英文逗号隔开
